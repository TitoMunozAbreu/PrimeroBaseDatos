...
INSERT INTO empresa.DEPARTAMENTO VALUES (20, 'INVESTIGACION', 'MADRID');
INSERT INTO empresa.DEPARTAMENTO VALUES (30, 'VENTAS', 'BARCELONA');
INSERT INTO empresa.DEPARTAMENTO VALUES (40, 'PRODUCCON', 'BILBAO');
...
CREATE INDEX EMP_NOMBRE ON empresa.EMPLEADO (NOMBRE);
CREATE INDEX EMP_DEPT_NO_EMP ON empresa.EMPLEADO (DEPT_NO,EMP_NO);

INSERT INTO empresa.EMPLEADO VALUES (7369,'SÁNCHEZ','EMPLEADO',7902, '1980-12-17', 104000,NULL,20);
INSERT INTO empresa.EMPLEADO VALUES (7499,'ARROYO','VENDEDOR',7698, '1980-02-20', 208000,39000,30);
INSERT INTO empresa.EMPLEADO VALUES (7521,'SALA','VENDEDOR',7698, '1981-02-22', 162500,65000,30);
INSERT INTO empresa.EMPLEADO VALUES (7566,'JIMÉNEZ','DIRECTOR',7839, '1981-04-02', 386750,NULL,20);
INSERT INTO empresa.EMPLEADO VALUES (7654,'MARTÍN','VENDEDOR',7698, '1981-09-29', 162500,182000,30);
INSERT INTO empresa.EMPLEADO VALUES (7698,'NEGRO','DIRECTOR',7839, '1981-05-01', 370500,NULL,30);
INSERT INTO empresa.EMPLEADO VALUES (7782,'CEREZO','DIRECTOR',7839, '1981-06-09', 318500,NULL,10);
INSERT INTO empresa.EMPLEADO VALUES (7788,'GIL','ANALISTA',7566, '1981-11-09', 390000,NULL,20);
INSERT INTO empresa.EMPLEADO VALUES (7839,'REY','PRESIDENTE',NULL, '1981-11-17', 650000,NULL,10);
INSERT INTO empresa.EMPLEADO VALUES (7844,'TOVAR','VENDEDOR',7698, '1981-09-08', 195000,0,30);
INSERT INTO empresa.EMPLEADO VALUES (7876,'ALONSO','EMPLEADO',7788, '1981-09-23', 143000,NULL,20);
INSERT INTO empresa.EMPLEADO VALUES (7900,'JIMENO','EMPLEADO',7698, '1981-12-03', 123500,NULL,30);
INSERT INTO empresa.EMPLEADO VALUES (7902,'FERNÁNDEZ','ANALISTA',7566, '1981-12-03', 390000,NULL,20);
INSERT INTO empresa.EMPLEADO VALUES (7934,'MUÑOZ','EMPLEADO',7782, '1982-01-23', 169000,NULL,10);
...
CREATE TABLE IF NOT EXISTS empresa.CLIENTE (
 CLIENTE_CODIGO          INT(6) UNSIGNED PRIMARY KEY,
...
CREATE INDEX CLIENT_NOM ON empresa.CLIENTE (NOMBRE);
CREATE INDEX CLIENT_REPR_CLI ON empresa.CLIENTE (REPR_COD, CLIENTE_CODIGO);


INSERT INTO empresa.CLIENTE (CLIENTE_CODIGO, NOMBRE, DIRECCION, CIUDAD, ESTADO, CP, AREA, 
...
CREATE TABLE IF NOT EXISTS empresa.PRODUCTO (
 PRODUCTO_NUMERO     INT (6) UNSIGNED PRIMARY KEY,
 DESCRIPCION   VARCHAR (30) NOT NULL  UNIQUE);


INSERT INTO empresa.PRODUCTO (PRODUCTO_NUMERO, DESCRIPCION)
...
CREATE TABLE IF NOT EXISTS empresa.PEDIDO  (
 PEDIDO_NUMERO             SMALLINT(4) UNSIGNED PRIMARY KEY,
 PEDIDO_FECHA            DATE,
 PEDIDO_TIPO           CHAR (1) CHECK (PEDIDO_TIPO IN ('A','B','C')),
 CLIENTE_CODIGO          INT (6) UNSIGNED NOT NULL,
 FECHA_ENVIO        DATE,
 TOTAL               DECIMAL(8,2) UNSIGNED,
 INDEX IDX_COMANDA_CLIENT_COD (CLIENTE_CODIGO),  
 FOREIGN KEY (CLIENTE_CODIGO) REFERENCES empresa.CLIENTE(CLIENTE_CODIGO) );

CREATE INDEX COMANDA_DATA_NUM ON empresa.PEDIDO (PEDIDO_FECHA,PEDIDO_NUMERO);
CREATE INDEX COMANDA_TRAMESA_NUM ON empresa.PEDIDO (FECHA_ENVIO,PEDIDO_NUMERO);


INSERT INTO empresa.PEDIDO (PEDIDO_NUMERO, PEDIDO_FECHA, PEDIDO_TIPO, CLIENTE_CODIGO, FECHA_ENVIO, TOTAL)
...
CREATE TABLE IF NOT EXISTS empresa.DETALLE  (
 PEDIDO_NUMERO             SMALLINT(4) UNSIGNED,
 DETALLE_NUMERO          SMALLINT(4) UNSIGNED,
 PRODUCTO_NUMERO            INT(6) UNSIGNED NOT NULL,
 PRECIO_VENTA          DECIMAL(8,2) UNSIGNED,
 CANTIDAD           INT (8),
 IMPORTE              DECIMAL(8,2),
 CONSTRAINT DETALL_PK PRIMARY KEY (PEDIDO_NUMERO,DETALLE_NUMERO),
 INDEX IDX_DETAL_COM_NUM (PEDIDO_NUMERO),
 INDEX IDX_PROD_NUM (PRODUCTO_NUMERO),
 FOREIGN KEY (PEDIDO_NUMERO) REFERENCES empresa.PEDIDO(PEDIDO_NUMERO),
 FOREIGN KEY (PRODUCTO_NUMERO) REFERENCES empresa.PRODUCTO(PRODUCTO_NUMERO));


CREATE INDEX DETALL_PROD_COM_DET ON empresa.DETALLE (PRODUCTO_NUMERO,PEDIDO_NUMERO,DETALLE_NUMERO);


INSERT INTO empresa.DETALLE (PEDIDO_NUMERO, DETALLE_NUMERO, PRODUCTO_NUMERO, PRECIO_VENTA, CANTIDAD, IMPORTE)
